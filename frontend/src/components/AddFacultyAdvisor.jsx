...
const AddFacultyAdvisor = () => {
  ...
  const [form, setForm] = useState({ name: '', email: '', department: '', phone: '', employeeId: '' });
  ...
  const handleAddFaculty = async () => {
    ...
    try {
      ...
      setFormError(err.response?.data?.message || 'Failed to add faculty advisor.');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="h-screen overflow-hidden flex font-display text-white" style={{backgroundColor: '#FFFBF2'}}>
      {/* Sidebar Navigation */}
      <aside className="w-[260px] flex flex-col shrink-0 h-screen sticky top-0 px-4 pt-7 pb-5" style={{backgroundColor: '#000000', color: '#FFFFFF'}}>
        ...
        <nav className="flex-1 flex flex-col gap-1">
          ...
          >
            ...
            <span className="text-[0.92rem]">Faculty Members</span>
          </Link>
          <Link 
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-y-auto relative flex flex-col items-center justify-center p-8" style={{backgroundColor: '#FFFBF2'}}>
        
        <div className="w-full max-w-2xl z-10">
          <header className="mb-8 text-center">
            <h2 className="text-4xl font-black tracking-tight mb-2" style={{color: '#1a1a2e'}}>Add New Faculty Advisor</h2>
            <p className="text-base" style={{color: '#6b7280'}}>Register a new faculty advisor to the SAPT administrative management system.</p>
          </header>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-2 md:col-span-2">
                  <label className="text-xs font-bold uppercase tracking-widest ml-1" style={{color: '#1a1a2e'}}>Full Name</label>
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold uppercase tracking-widest ml-1" style={{color: '#1a1a2e'}}>Employee ID</label>
                  <div className="relative group">
                ...
                {/* Department Dropdown */}
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold uppercase tracking-widest ml-1" style={{color: '#1a1a2e'}}>Department</label>
                  <div className="relative group">
                    ...
                    <select 
                      ...
                      onBlur={(e) => e.target.style.borderColor = '#e5e1d8'}
                    >
                      <option value="" disabled selected style={{backgroundColor: '#ffffff', color: '#6b7280'}}>Select Department</option>
                      <option value="cse" style={{backgroundColor: '#ffffff', color: '#1a1a2e'}} className="py-2">Computer Science & Engineering (CSE)</option>
                      <option value="ece" style={{backgroundColor: '#ffffff', color: '#1a1a2e'}} className="py-2">Electronics & Communication Engineering (ECE)</option>
                      <option value="eee" style={{backgroundColor: '#ffffff', color: '#1a1a2e'}} className="py-2">Electrical & Electronics Engineering (EEE)</option>
                      <option value="ch" style={{backgroundColor: '#ffffff', color: '#1a1a2e'}} className="py-2">Chemical Engineering (CH)</option>
                      <option value="me" style={{backgroundColor: '#ffffff', color: '#1a1a2e'}} className="py-2">Mechanical Engineering (ME)</option>
                      <option value="ce" style={{backgroundColor: '#ffffff', color: '#1a1a2e'}} className="py-2">Civil Engineering (CE)</option>
                      <option value="bt" style={{backgroundColor: '#ffffff', color: '#1a1a2e'}} className="py-2">Biotechnology (BT)</option>
                      <option value="mse" style={{backgroundColor: '#ffffff', color: '#1a1a2e'}} className="py-2">Materials Science & Engineering (MSE)</option>
                      <option value="pe" style={{backgroundColor: '#ffffff', color: '#1a1a2e'}} className="py-2">Production Engineering (PE)</option>
                      <option value="ep" style={{backgroundColor: '#ffffff', color: '#1a1a2e'}} className="py-2">Engineering Physics (EP)</option>
                    </select>
                    <span className="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none" style={{color: '#f5a623'}}>expand_more</span>
                  </div>
                </div>
                
                {/* Mobile Number */}
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold uppercase tracking-widest ml-1" style={{color: '#1a1a2e'}}>Mobile Number</label>
                  <div className="relative group">
                ...
                {/* Email Address */}
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold uppercase tracking-widest ml-1" style={{color: '#1a1a2e'}}>Email Address</label>
                  <div className="relative group">
              ...
              {/* Activation Toggle */}
              <div className="pt-4 flex items-center justify-between p-4 rounded-xl border" style={{backgroundColor: '#fafaf8', borderColor: '#e5e1d8'}}>
                <div className="flex flex-col">
                  <span className="text-sm font-bold" style={{color: '#1a1a2e'}}>Send Activation Email</span>
                  <span className="text-xs" style={{color: '#6b7280'}}>Faculty will receive an email to set their password immediately.</span>
                </div>
              ...
              {/* Actions */}
              {formError && (
                <div style={{ padding: '10px 14px', borderRadius: '8px', backgroundColor: '#fef2f2', border: '1px solid #fecaca', color: '#dc2626', fontSize: '0.85rem' }}>
                  {formError}
                </div>
              )}
