      ...
      <main className="flex-1 overflow-y-auto relative flex flex-col items-center justify-center p-8" style={{backgroundColor: '#FFFBF2'}}>
        ...
        <div className="w-full max-w-2xl z-10">
          <header className="mb-8 text-center">
            <h2 className="text-4xl font-black tracking-tight mb-2" style={{color: '#1a1a2e'}}>Add New Student User</h2>
            <p className="text-base" style={{color: '#6b7280'}}>Register a new student to the SAPT administrative management system.</p>
          </header>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold uppercase tracking-widest ml-1" style={{color: '#1a1a2e'}}>Roll Number</label>
                  <div className="relative group">
              ...
              <div className="pt-4 flex items-center justify-between p-4 rounded-xl border" style={{backgroundColor: '#fafaf8', borderColor: '#e5e1d8'}}>
                <div className="flex flex-col">
                  ...
                  <span className="text-xs" style={{color: '#6b7280'}}>Student will receive an email to set their password immediately.</span>
                </div>
