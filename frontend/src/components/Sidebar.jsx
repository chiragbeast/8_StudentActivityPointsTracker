...
export default function Sidebar() {
    ...
    return (
        <aside style={{
            ...
            padding: '28px 16px 20px', zIndex: 100, fontFamily: 'Inter, sans-serif'
        }}>
            {/* Brand */}
            ...
            <button
                ...
                style={{
                    ...
                    width: '100%', padding: '11px', backgroundColor: '#f5a623', color: '#1a1a2e',
            ...
            >
                <svg style={{width:'16px',height:'16px'}} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5"><path d="M12 4v16m8-8H4" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                New Submission
            </button>
            ...
            <div ref={menuRef} style={{position: 'relative'}}>
                ...
                {showMenu && (
                    <div style={{
                        ...
                        <button
                            onClick={(e) => { e.stopPropagation(); setShowMenu(false); navigate('/settings'); }}
                        ...
                        <button
                            onClick={(e) => { e.stopPropagation(); setShowMenu(false); localStorage.clear(); navigate('/login'); }}
                ...
                <div
                    ...
                    onMouseOut={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
                >
                    <div style={{width:'38px',height:'38px',borderRadius:'50%',background:'linear-gradient(135deg, #f5a623, #f7b731)',color:'#1a1a2e',display:'flex',alignItems:'center',justifyContent:'center',fontWeight:'700',fontSize:'0.95rem',flexShrink:0}}>C</div>
                    <div style={{display:'flex',flexDirection:'column'}}>
                        <span style={{fontSize:'0.9rem',fontWeight:'600',color:'#fff'}}>Chirag</span>
                        <span style={{fontSize:'0.78rem',color:'#9ca3af'}}>(B23065CS)</span>
                    </div>
                </div>
            </div>
        </aside>
