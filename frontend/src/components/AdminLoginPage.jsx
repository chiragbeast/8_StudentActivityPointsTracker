...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center overflow-hidden" style={{backgroundColor: '#fdf8f0', fontFamily: 'Poppins, sans-serif'}}>
      {/* Main content */}
      <main className="flex-1 flex flex-col items-center px-6 pt-[124px] pb-8 w-full relative z-10">
        <h1 className="text-[2rem] font-extrabold mb-2" style={{color: '#1a1a2e', letterSpacing: '-0.5px'}}>
          Welcome Back
        </h1>
        ...
        {/* Role tabs */}
        <div className="flex w-full max-w-[400px] mb-7 p-1 rounded-xl" style={{backgroundColor: '#f5f5f0'}}>
        ...
        <form className="w-full max-w-[400px]" onSubmit={handleSubmit}>
          <div className="mb-5">
            <label htmlFor="email" className="block text-[0.85rem] font-semibold mb-2" style={{color: '#1a1a2e'}}>
              ID/Email
            </label>
            <div className="flex items-center bg-white border-[1.5px] rounded-xl px-4 transition-all focus-within:border-[#f5a623] focus-within:shadow-[0_0_0_3px_rgba(245,166,35,0.12)]" style={{borderColor: '#e5e1d8'}}>
              <svg className="w-[1.15rem] h-[1.15rem] flex-shrink-0" style={{color: '#9ca3af'}} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                <path d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" strokeLinecap="round" strokeLinejoin="round"></path>
              </svg>
              <input
                id="email"
                type="text"
          ...
          <div className="mb-5">
            <label htmlFor="password" className="block text-[0.85rem] font-semibold mb-2" style={{color: '#1a1a2e'}}>
              Password
            </label>
            <div className="flex items-center bg-white border-[1.5px] rounded-xl px-4 transition-all focus-within:border-[#f5a623] focus-within:shadow-[0_0_0_3px_rgba(245,166,35,0.12)]" style={{borderColor: '#e5e1d8'}}>
              <svg className="w-[1.15rem] h-[1.15rem] flex-shrink-0" style={{color: '#9ca3af'}} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
              ...
              >
                {showPassword ? (
                  <svg className="w-[1.15rem] h-[1.15rem]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                    <path d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" strokeLinecap="round" strokeLinejoin="round"></path>
                  </svg>
                ) : (
                  <svg className="w-[1.15rem] h-[1.15rem]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
            ...
            <div className="flex justify-end mt-2">
              <a href="#" className="text-[0.85rem] font-medium no-underline transition-colors" style={{color: '#f5a623'}} onMouseOver={(e) => e.target.style.color = '#d4891a'} onMouseOut={(e) => e.target.style.color = '#f5a623'}>
                Forgot Password?
              </a>
            </div>
          </div>
        ...
        <p className="mt-7 text-[0.9rem]" style={{color: '#6b7280'}}>
          Don't have an account?{' '}
          <a href="#" className="font-semibold no-underline transition-colors" style={{color: '#f5a623'}} onMouseOver={(e) => e.target.style.color = '#d4891a'} onMouseOut={(e) => e.target.style.color = '#f5a623'}>
            Request Access
          </a>
        </p>
      </main>
