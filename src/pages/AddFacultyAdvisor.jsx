      ...
      <main className="flex-1 overflow-y-auto bg-[#0a060e] relative flex flex-col items-center justify-center p-8">
        ...
        <div className="w-full max-w-2xl z-10">
          <header className="mb-8 text-center">
            <h2 className="text-4xl font-black text-white tracking-tight mb-2">Add New Faculty Advisor</h2>
            <p className="text-slate-400 text-base">Register a new faculty advisor to the SAPT administrative management system.</p>
          </header>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-primary ml-1">Employee ID</label>
                  <div className="relative group">
              ...
              <div className="pt-4 flex items-center justify-between bg-primary/5 p-4 rounded-xl border border-primary/10">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-slate-400">Faculty will receive an email to set their password immediately.</span>
                </div>
